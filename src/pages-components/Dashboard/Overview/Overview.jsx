      ...
      <div className="addOrganization mb-1 d-flex align-items-center justify-content-between p-5">
        <div className="app-page-title--first">
          ...
          <div className="app-page-title--heading">
            <h1 style={{ color: "#3A3D65" }}>Dashboards</h1>
          </div>
        </div>
      </div>
      <div className="p-5">
        <Row>
          ...
          <Col md={12} style={{ marginTop: "40px" }}></Col>
          <Col md={6}>
            <ListGroupItemC color={"#03A9F4"} heading="Favorites" star={true} />
          </Col>
          <Col md={6}>
          ...
          <Col md={12} style={{ marginTop: "40px" }}></Col>
          <Col md={6}>
            <ListGroupItemC color={"#03A9F4"} heading="Announcement" />
          </Col>
          <Col md={6}>
            <ListGroupItemC color={"#00C74E"} heading="On Leave Today" />
          </Col>

          <Col md={12} style={{ marginTop: "40px" }}></Col>
          <Col md={6}>
            <ListGroupItemC color={"#03A9F4"} heading="On Boarding" />
          </Col>
          <Col md={6}>
            <ListGroupItemC color={"#00C74E"} heading="Off Boarding" />
          </Col>
        </Row>
      </div>
    </div>
