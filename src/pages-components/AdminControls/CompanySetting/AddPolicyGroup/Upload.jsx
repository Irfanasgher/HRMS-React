      ...
      <div className="dropzone">
        <div {...getRootProps({ className: "dropzone-upload-wrapper" })}>
          ...
          <div className="dropzone-inner-wrapper">
            ...
            {!isDragActive && (
              <div>
                <div className="d-100 btn-icon mb-3 hover-scale-lg bg-white shadow-light-sm text-primary">
                  <FaPlus className="d-50" />
                </div>
                <div className="font-size-sm">
                  Add the Plans that you'd like to apply to this group <br />
