...
import { createRegularShift } from "../../../../../actions";
...
const AddNewShift = () => {
  ...
  let chk_label = "Overtime is Applicable on this Shift";
  ...
  const addRegularShift = (values) => {
    ...
    const data = [
      {
        name_regular_shift: values.shiftName,
        code_regular_shift: days1,
        time_slots: [
          {
            is_over_time_slot: checkOvertime,
    ...
    dispatch(createRegularShift(data)).then((e) => {
      history.push({
  ...
  console.log("checkOvertime", checkOvertime);
  return (
    <div id="addNewShift">
              ...
              <Form onSubmit={handleSubmit}>
                <div className="pt-3 tableContainer m-1">
                  ...
                  <div className="d-flex align-items-center justify-content-end w-100 p-4">
                    <Button color="primary" onClick={() => addBreakBank()}>
