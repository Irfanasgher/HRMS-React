...
import "./UpdateRegularShift.scss";
import {
  UpdateRegularShiftData,
  UpdateShiftTimeSlot,
  UpdateShiftBreakBank,
} from "../../../../../actions";

const UpdateRegularShift = () => {
  ...
  let finalDays = [];
  let codeSeasonal = location?.state?.data?.regular_shift?.code_regular_shift;
  ...
  const handleUpdateNameToggle = (data) => {
    setName(data?.name_regular_shift);
    setNameId(data?.id_regular_shift);
  ...
  const updateName = (e) => {
    ...
    const data = {
      name_regular_shift: name,
      code_regular_shift: days,
    };

    console.log("data on submit", data);
    if (name.length > 0 && days.length > 0) {
      dispatch(UpdateRegularShiftData(data, nameId)).then((e) => {
        history.push({
          pathname: `/dashboard/AttendanceSystem`,
        });
      });
  ...
  return (
    <div id="addNewSeasonalShift">
      ...
      >
        <ModalHeader toggle={updateNameToggle}>Regular Shift</ModalHeader>
        <ModalBody>
      ...
      <div className="addOrganization mb-1 d-flex align-items-center justify-content-between p-5">
        <div className="app-page-title--first">
          ...
          <div className="app-page-title--heading">
            <h1 style={{ color: "#3A3D65" }}>Update Regular Shift</h1>
          </div>
        </div>
      </div>
      <div className="p-5">
                    ...
                    <div
                      ...
                      onClick={() =>
                        handleUpdateNameToggle(
                          location?.state?.data?.regular_shift
                        )
                      }
                    >
                ...
                <Col md="6">
                  <FormGroup>
                    ...
                    <Input
                      ...
                      readOnly
                      defaultValue={
                        location?.state?.data?.regular_shift?.name_regular_shift
                      }
                    />
                  </FormGroup>
                </Col>
                ...
                >
                  <div className="d-flex justify-content-between align-items-center">
                    <div className="information">
                      <Label for="">Regular Shift Timing</Label>
                    </div>
                    <div
                      className="editContainer"
                      onClick={() =>
