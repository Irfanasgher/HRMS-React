      ...
      <div className="addOrganization mb-1 d-flex align-items-center justify-content-between p-5">
        <div className="app-page-title--first">
          ...
          <div className="app-page-title--heading">
            <h1 style={{ color: "#3A3D65" }}>Asset Request</h1>
          </div>
        </div>
      </div>
      <div className="p-5">
        <div className="pt-3 tableContainer m-1">
          ...
          <div className="p-5">
            ...
            >
              Managers can request an employee get a company asset.
            </p>
            <Link to="/dashboard/AssetRequest/AddNewAssetRequest">
          ...
          >
            <thead className="font-size-sm" style={{ background: "#F3F5FD" }}>
              <tr>
                ...
                <th className="text-center p-3">Requested Option</th>
                <th className="text-center p-3">Approved By</th>
