      ...
      <div className="p-5">
        <div className="pt-3 tableContainer m-1">
          ...
          <div className="p-5">
            ...
            >
              Use this approval for requesting changes to an employee's
              compensation. The request will contain all fields in the
              compensation table. Additional fields may be added to the request.
            </p>
            <Link to="/dashboard/Compensations/AddNewApproval">
