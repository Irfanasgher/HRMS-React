...
import "./AddNewEmployeeStatus.scss";

const AddNewEmployeeStatus = () => {
  return (
    <div id="addNewEmployeeStatus">
      <div className="addOrganization mb-1 d-flex align-items-center justify-content-between p-5">
        <div className="app-page-title--first">
          ...
          <div className="app-page-title--heading">
            <h1 style={{ color: "#3A3D65" }}>Add New Employee Status</h1>
          </div>
        </div>
      </div>
...
export default AddNewEmployeeStatus;
